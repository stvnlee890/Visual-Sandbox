...
.to('.inner-box', { opacity: .5, y: 0, duration: .2},  "-=1")
.from('.cards', { opacity: 0, scaleY: 0, stagger: .3 }, "-=2")
.from(flagPoles, { duration: 3, opacity: 0, transform: "translateY(250px)" }, "-=3")
.from('.title-desc, .desc', { stagger: .1, duration: 1, opacity: 0, y: "100px" }, "-=3")
